        ...
        <div class="col-xl-7 order-xl-1">
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    @if ($u->currentLevel() > 1)
                        <div class="jquery_level2_class row" data-class="row">
                            <div class="jquery_level2_class col-md-4" data-class="col-md-4"><!--</div></div>-->
                                @endif
                                ...
                                <div class="form-group row"><!-- SUBJECT -->
                                    ...
                                    <div class="{{ $u->currentLevel()==1 ? 'col-lg-10' : 'col-lg-9' }} level_class"
                                         data-level-1-class="col-lg-10" data-level-2-class="col-lg-9">
                                ...
                                @if ($u->isAdmin())
                                    <div class="form-group row" style="margin-bottom: 1.5em"><!-- OWNER -->
                                        <label for="owner_id"
                                               class="{{ $u->currentLevel()==1 ? 'col-lg-2' : 'col-lg-3' }} level_class col-form-label tooltip-info"
                                               data-level-1-class="col-lg-2" data-level-2-class="col-lg-3"
                                        ...
                                        <div class="{{ $u->currentLevel()==1 ? 'col-lg-10' : 'col-lg-9' }} level_class"
                                            ...
                                            <select id="owner_id" name="owner_id"
                                                    class="generate_default_select2 form-control"
                                ...
                                @else
                                    {!! CollectiveForm::hidden('owner_id', $u->id) !!}
                                @endif

                                @if ($u->currentLevel() > 1)
                                    <div class="jquery_level2_show">
                                        <div class="form-group row align-items-center">
                                            <label class="col-lg-3 col-form-label tooltip-info"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="hidden"
                                                               value="false" {{ (!isset($ticket) || (isset($ticket) && !$ticket->hidden)) ? 'checked' : '' }}> {{ trans('panichd::lang.yes') }}
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" name="hidden"
                                                               value="true" {{ (isset($ticket) && $ticket->hidden) ? 'checked' : ''}}> {{ trans('panichd::lang.no') }}
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row align-items-center" style="margin-bottom: 1.5em">
                                            <!-- TICKET LIST -->
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                @foreach ($a_lists as $list => $a_list)
                                                    <div class="form-check form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" id="radio_{{ $list }}_list"
                                                                   class="jquery_ticket_list form-check-input"
                                                                   name="complete" value="{{ $a_list['complete'] }}"
                                                                   @if($list == $checked_list)
                                                                       {!! 'checked="checked"' !!}
                                                                   @endif data-list="{{ $list }}"
                                                                   data-default_status_id="{{ $a_list['default_status_id'] }}">{{ trans('panichd::lang.' . $list . '-tickets-adjective') }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                        ...
                                        @if ($tag_lists->count() > 0)
                                            ...
                                            @if($u->isAdmin())
                                                <div class="form-group row" style="display: none">
                                                    ...
                                                    <div id="new_tags_container"
                                                         class="col-lg-9 grouped_check_list deletion_list no-border coloured-list">
                            ...
                            <div class="jquery_level2_class col-md-8" data-class="col-md-8">
                                @endif

                                <div class="form-group row"><!-- DESCRIPTION -->
                                    <label for="content" class="col-lg-2 col-form-label tooltip-info"
                                ...
                                @if ($u->currentLevel() > 1)
                                    <div class="jquery_level2_show">
                                        <div class="form-group row"><!-- INTERVENTION -->
                                            <label for="intervention" class="col-lg-2 col-form-label tooltip-info"
                                                   title="{{ trans('panichd::lang.create-ticket-intervention-help') }}">{{ trans('panichd::lang.intervention') . trans('panichd::lang.colon') }}
                                                <span class="fa fa-question-circle" style="color: #bbb"></span></label>
                                            <div class="col-lg-10 summernote-text-wrapper">
                                                <textarea class="form-control summernote-editor" style="display: none"
                                                          rows="5" name="intervention"
                                                          cols="50">{!! $a_current['intervention'] !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="text-center"><!-- SUBMIT BUTTON -->
                        @if ($u->currentLevel() > 1)
                            <button type="button" id="add_comment"
                                    class="btn btn-light btn-default mr-4">{{ trans('panichd::lang.show-ticket-add-comment') }}</button>
                        @endif
